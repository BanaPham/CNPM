...
public class ReturnLoanRecordDaoTest {
    ...
    public void setUp() throws Exception {
        ...
        try (Statement stmt = con.createStatement()) {
            ...
            stmt.execute("DELETE FROM tblloandetail WHERE id = 999");
            stmt.execute("DELETE FROM tblloanrecord WHERE id = 999");
            ...
            stmt.execute("INSERT INTO tblloanrecord(id, loan_date, due_date, patron_id, fine_amount) VALUES(999, '2026-05-10 08:00:00', '2026-05-24 08:00:00', 999, 0.0)");
            stmt.execute("INSERT INTO tblloandetail(id, loan_record_id, item_id, actual_return_date, fine_amount, status_notes) VALUES(999, 999, 999, NULL, 0.0, 'Muon moi')");
    ...
    public void testGetActiveLoanDetailStandard() {
        ...
        Assert.assertEquals(999, detail.getLoanRecord().getId());
