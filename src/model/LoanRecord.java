...
public class LoanRecord implements Serializable {
	...
	public String getTblSystemUserID() {
    	return tblSystemUserID;
	}
 
	public void setTblSystemUserID(String tblSystemUserID) {
        this.tblSystemUserID = tblSystemUserID;
	}
 
	public String getTblPatronID() {
    	return tblPatronID;
	}
 
	public void setTblPatronID(String tblPatronID) {
        this.tblPatronID = tblPatronID;
	}
}
