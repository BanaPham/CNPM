...
public class LoanDetail implements Serializable {
	...
	public String getTblLoanRecordID() {
    	return tblLoanRecordID;
	}
 
	public void setTblLoanRecordID(String tblLoanRecordID) {
        this.tblLoanRecordID = tblLoanRecordID;
	}
 
	public String getTblItemID() {
    	return tblItemID;
	}
 
	public void setTblItemID(String tblItemID) {
    	this.tblItemID = tblItemID;
	}
